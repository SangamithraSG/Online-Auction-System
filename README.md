...
cd <your-repo>
Compile (example, adjust PATH_TO_JAVAFX_LIB):

bash
mkdir bin
for /r src %f in (*.java) do javac --module-path "PATH_TO_JAVAFX_LIB" --add-modules javafx.controls -d bin -sourcepath src "%f"
Run:

bash
java --module-path "PATH_TO_JAVAFX_LIB" --add-modules javafx.controls -cp bin com.auction.javafx.AuctionApplication
Replace <your-username>, <your-repo>, and PATH_TO_JAVAFX_LIB with your actual values.
